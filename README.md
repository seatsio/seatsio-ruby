...
```ruby
require('seatsio')
client = Seatsio::Client.new(Seatsio::Region.US(), "my-workspace-secret-key") # can be found on https://app.seats.io/workspace-settings
...
```ruby
require('seatsio')
client = Seatsio::Client.new(Seatsio::Region.US(), "my-workspace-secret-key")
...
```ruby
require('seatsio')
client = Seatsio::Client.new(Seatsio::Region.US(), "my-company-admin-key")
