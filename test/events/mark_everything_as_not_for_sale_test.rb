...
class MarkEverythingAsNotForSaleTest < SeatsioTestClient
  def test_mark_everything_as_not_for_sale
    ...
    @seatsio.events.mark_everything_as_not_for_sale key: event.key
    ...
    assert_equal({}, retrieved_event.for_sale_config.area_places)
