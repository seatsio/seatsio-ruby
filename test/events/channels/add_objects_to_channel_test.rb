...
class AddObjectsToChannelTest < SeatsioTestClient
  ...
  def test_add_objects_to_channel
    ...
    expected_channels = [
      Seatsio::Channel.new("channelKey1", retrieved_event.channels[0].id, "channel 1", "#FFFF98", 1, ['A-1', 'A-2', 'A-3', 'A-4'], {}),
      Seatsio::Channel.new("channelKey2", retrieved_event.channels[1].id, "channel 2", "#FFFF99", 2, [], {})
    ]
