...
class CopyChartToSubaccountTest < SeatsioTestClient
  def test_copy_chart_to_subaccount
    ...
    chart = Seatsio::Client.new(from_subaccount.secret_key, 'https://api-staging.seatsio.net').charts.create name: 'aChart'
    ...
    retrieved_chart = Seatsio::Client.new(to_subaccount.secret_key, 'https://api-staging.seatsio.net').charts.retrieve(copied_chart.key)
