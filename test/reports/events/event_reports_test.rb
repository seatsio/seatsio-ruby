...
class EventReportsTest < SeatsioTestClient
  ...
  def test_report_item_properties
    ...
    assert_nil(report_item.parent_displayed_object_type)
  ...
  def test_report_item_properties_for_GA
    ...
    assert_nil(report_item.has_lift_up_armrests)
    assert_nil(report_item.is_hearing_impaired)
    assert_nil(report_item.is_semi_ambulatory_seat)
    assert_nil(report_item.has_sign_language_interpretation)
